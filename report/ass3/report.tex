...
We agreed to add to the ontology the concept of \texttt{Workout} and \texttt{Heart\_Rate} that weren't included in our model but weren't difficult to include. \todo{check my english please}
